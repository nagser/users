...
<!--                --><?//= $form->field($model, 'image')->widget(\app\modules\gallery\components\image\FormImageWidget::className(), [
//                    'imageSrc' => $model->getImageSrc('md_'),
//                    'deleteUrl' => ['deleteImage', 'user_id' => $model->getPrimaryKey()],
//                    'cropUrl' => ['cropImage', 'user_id' => $model->getPrimaryKey()],
